;;; nano-faces.el --- Face settings for nano-emacs -*- lexical-binding: t -*-
;;; License:
;; ---------------------------------------------------------------------
...
(defcustom nano-font-family-monospaced "SF Mono"
  "Name of the font-family to use for nano.
Defaults to SF Mono."
  :group 'nano
  :type 'string)

(defcustom nano-font-family-proportional "SF Pro Display"
  "Font to use for variable pitch faces.
Defaults to SF Pro Display."
  :group 'nano
  :type 'string)
